...
function get_mixpanel_setup() {
?> 
<!-- start get_mixpanel_setup() -->
...
<!-- end get_mixpanel_setup() -->
<?php	
}

function get_facebook_and_twitter_setup() {
?>
<!-- start get_facebook_and_twitter_setup() -->
<div id="fb-root"></div>
...
<!-- end get_facebook_and_twitter_setup() -->
<?php	
}

// add other vendor JS library/whatever stuff.... but should this be in 'wp_head' action anyway? :/